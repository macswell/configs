...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(evil-org)
...
(display-time-mode 1)
 (setq org-capture-templates
      (quote (("t" "todo" entry (file "~/Dropbox/Emacs/orgzly/capture.org")
               "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
             ("n" "note" entry (file "~/Dropbox/Emacs/orgzly/capture.org")
               "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
